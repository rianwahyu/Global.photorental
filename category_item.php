    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Master Category</h4>
            ...
            <div class="container-fluid">
                ...
                $query2 = " SELECT MAX(id) as id FROM category_tbl ";
                ...
                <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form class="mt-2" action="config/category_item/addCategoryItem.php" method="POST">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-subtitle">Category List at Global Photorental</h5>
                                ...
                                //     $customSearch = "(category_name LIKE '%$search%' OR id LIKE '%$search%') ";
                                // }
                                ...
                                if (empty($search)) {
                                    ...
                                    foreach ($search_exploded as $search_each) {
                                        $x++;
                                        $construct .= " AND (category_name LIKE '%$search_each%' ";
                                ...
                                $query = "SELECT a.id, a.category_name
                                            FROM `category_tbl` a 
                                ...
                                <a href="category_item"><button class="btn btn-success text-center">Display All</button></a>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div id="updateUser<?= $data['id'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    ...
                                                                    <form class="mt-2" action="config/category_item/editCategoryItem.php" method="POST">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <form action="config/category_item/deleteCategoryItem.php" method="POST">
                                                                    <input type="hidden" name="id" value="<?= $data['id'] ?>" />
                                                                    <div class="modal-content modal-filled bg-danger">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title" id="fill-danger-modalLabel">Delete Category
                                                                            </h4>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                                        </div>
                                                                        <div class="modal-body">
